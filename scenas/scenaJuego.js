class scenaJuego extends Phaser.Scene {
  ...
  addMobileControls() {
    ...
    const offsetX = 40; // Espaciado horizontal entre botones
    const offsetY = 40; // Espaciado vertical entre botones
    const startX = width - 50; // Posición inicial en X (derecha)
